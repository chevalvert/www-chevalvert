...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:wfw="http://wellformedweb.org/CommentAPI/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:atom="http://www.w3.org/2005/Atom">
  ...
  <channel>
    ...
    <item>
      ...
      <pubDate><?php echo $datefield == 'modified' ? $item->modified('%a, %d %b %Y %H:%M:%S %z') : $item->date('%a, %d %b %Y %H:%M:%S %z', $datefield) ?></pubDate>
      <description><![CDATA[<?php echo excerpt($item->text()->kirbytext(), 300) ?>]]></description>
    </item>
    <?php endforeach ?>
